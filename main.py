...
available_models = {  # add custom configurations in this dict
    ...
    "TF": vision_transformer,
    "TF-ALT": vision_transformer_sinusenc,
    "TF-NO": vision_transformer_noenc,
    ...
    "DCF": depthwise_conformer,
    "SDCF-NN": symmetric_depthwise_conformer_nn,
    "SDCF-NNN": symmetric_depthwise_conformer_nnn,
    "SGDCF-NN": symmetric_graph_depthwise_conformer_nn,
    "SGDCF-NNN": symmetric_graph_depthwise_conformer_nnn,
