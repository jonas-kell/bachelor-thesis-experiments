...
conv_1x1 = nn.Conv2d(in_channels=2, out_channels=5, kernel_size=1)
conv_3x4 = nn.Conv2d(in_channels=2, out_channels=5, kernel_size=(3, 4))
...
conv_1x1_code.weight.data.copy_((fcl.weight.data.view(*fcl.weight.data.shape, 1, 1)))
